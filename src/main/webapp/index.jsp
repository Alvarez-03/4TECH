  ...
  <body class="bg-slate-50 font-sans text-slate-800 antialiased selection:bg-brand-600 selection:text-white">
    ...
    <header class="relative overflow-hidden bg-gradient-to-b from-brand-50 via-white to-slate-50 py-20 lg:py-32 px-6">
      <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative mx-auto lg:ml-auto max-w-md lg:max-w-none w-full">
    ...
    <section id="que-es" class="py-20 px-6 max-w-6xl mx-auto border-t border-slate-100">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="bg-gradient-to-br from-brand-900 to-brand-700 text-white p-8 lg:p-12 rounded-3xl shadow-xl relative overflow-hidden">
    ...
    <section id="funcionalidades" class="bg-slate-900 text-white py-20 px-6">
      <div class="max-w-6xl mx-auto space-y-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="bg-slate-800 border border-slate-700 p-6 rounded-2xl space-y-4 transition-all hover:-translate-y-1">
    ...
    <section id="precios" class="py-20 px-6 max-w-5xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        <div class="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col justify-between shadow-sm relative transition-all hover:border-slate-300">
          <div class="space-y-6">
            <div>
        ...
        <div class="bg-white border-2 border-brand-600 rounded-2xl p-8 flex flex-col justify-between shadow-md relative transition-all">
