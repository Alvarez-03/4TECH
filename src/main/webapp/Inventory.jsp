...
<head>
    ...
    <script src="resources/ControlProveedores.js"></script>
</head>
...
<div class="max-w-7xl mx-auto my-8 px-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        ...
        <div class="flex gap-3 w-full md:w-auto">
            ...
            <button onclick="abrirModalProveedores()"
                    class="bg-gray-700 hover:bg-gray-800 text-white px-5 py-3 rounded-xl font-bold shadow-md transition-all flex items-center gap-2 active:scale-95">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                    <div class="flex justify-center gap-3">
                        <button onclick="abrirModalActualizarInventario(this)"
                                ...
                                data-proveedor="<%= p.getProveedorId() %>"
...
<%@include file="Components/FormModals/FormProveedores.jsp"%>
